...
# Correlation distance and average linkage
#png("/data/TCGA-PRAD/mimQTLs/spearman_heatmap.png", width = 8, height = 5, units="in", res = 300)
...
ggscatter(df, x=mir, y=cpg, add = "reg.line", add.params = list(color="red", linetype="dashed"), cor.coef = T, cor.method = "spearman", size = 0.9, ggtheme = theme_minimal())
